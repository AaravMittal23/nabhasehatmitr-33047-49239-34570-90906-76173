...
export default function Reports() {
  ...
  return (
    <div className="min-h-screen bg-reports-cream font-poppins">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {reports.map((report) => (
              <Card 
                key={report.id} 
                className="bg-reports-card border-reports-card-border border-2 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 p-8"
              >
                <CardContent className="p-0 space-y-6">
                  ...
                  <div className="flex gap-4 justify-center pt-4">
                    <Button
                      ...
                      className="bg-reports-view hover:bg-reports-view/90 text-white px-8 py-3 rounded-full font-medium font-poppins flex-1 max-w-[140px] transition-all duration-300 hover:shadow-lg hover:shadow-healthcare-green/25 transform hover:-translate-y-0.5"
                      aria-label={`View report for ${report.patientName}`}
                    >
                    ...
                    <Button
                      ...
                      className="bg-reports-download hover:bg-reports-download/90 text-white px-8 py-3 rounded-full font-medium font-poppins flex-1 max-w-[140px] transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 transform hover:-translate-y-0.5"
                      aria-label={`Download report for ${report.patientName}`}
                    >
