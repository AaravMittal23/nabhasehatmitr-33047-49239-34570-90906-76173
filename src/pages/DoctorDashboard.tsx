          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    Doctor Profile
                    {doctorData.verified && <Badge className="ml-2" style={{
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Input value={doctorData.name} onChange={e => handleProfileUpdate('name', e.target.value)} className="mt-1" />
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Input value={doctorData.hospital} onChange={e => handleProfileUpdate('hospital', e.target.value)} className="mt-1" />
                        <Edit className="h-4 w-4 text-muted-foreground" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Input value={doctorData.specialization} onChange={e => handleProfileUpdate('specialization', e.target.value)} className="mt-1" />
                        <Edit className="h-4 w-4 text-muted-foreground" />
                      </div>
                    </div>
                  </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    ...
                    <Button size="sm" onClick={() => setIsAddSlotOpen(true)} style={{
                    backgroundColor: '#45A06B'
                  }}>
                ...
                <CardContent>
                  ...
                  <div className="space-y-3">
                    {timeSlots.map(slot => <Card key={slot.id} className="border">
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            ...
                            <Button size="sm" variant="outline" onClick={() => handleRemoveSlot(slot.id)}>
                              <X className="h-4 w-4" />
                            </Button>
                          </div>
                        </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {todaysAppointments.map(appointment => <Card key={appointment.id} className="border-l-4" style={{
                    borderLeftColor: appointment.status === 'completed' ? '#45A06B' : appointment.status === 'in-progress' ? '#F59E0B' : '#0B2A4A'
                  }}>
                        <CardContent className="p-4">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <Badge variant={appointment.status === 'completed' ? 'default' : appointment.status === 'in-progress' ? 'secondary' : 'outline'}>
                                  {appointment.status}
                                </Badge>
                              </div>
                            ...
                            {appointment.status === 'scheduled' && <div className="flex flex-col sm:flex-row gap-2">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {todaysAppointments.slice(0, 3).map(appointment => <Card key={appointment.id} className="border">
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input type="date" value={newSlot.date} onChange={e => setNewSlot(prev => ({
              ...prev,
              date: e.target.value
            }))} className="mt-1" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="time" value={newSlot.startTime} onChange={e => setNewSlot(prev => ({
                ...prev,
              ...
              <div>
                ...
                <Input type="time" value={newSlot.endTime} onChange={e => setNewSlot(prev => ({
                ...prev,
